...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onResume() {
        super.onResume();
        if (sharedPreferences.getBoolean("save_scores", false)) {
            teamAScore = sharedPreferences.getInt("teamA_score", 0);
            teamBScore = sharedPreferences.getInt("teamB_score", 0);
    ...
    public void saveScores() {
        myEdit.putInt("teamA_score", teamAScore);
        myEdit.putInt("teamB_score", teamBScore);
        myEdit.commit();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_about:
                Toast.makeText(this, "Name : Mrudula and \n Course code - JAV-1001", Toast.LENGTH_SHORT).show();
                return true;
